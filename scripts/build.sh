...
npx json2ts --unreachableDefinitions --input dist/simard.json --output dist/types/simard.d.ts
npx json2ts --unreachableDefinitions --input dist/derbysoft.json --output dist/types/derbysoft.d.ts
cp index.js dist/index.js
cp index.d.ts dist/types/index.d.ts
